...
class ES1p1TestCase(AlgorithmTestCase):
	def test_algorithm_info_fine(self):
		i = EvolutionStrategy1p1.algorithmInfo()
...
class ESMp1TestCase(AlgorithmTestCase):
	def test_algorithm_info_fine(self):
		i = EvolutionStrategyMp1.algorithmInfo()
		self.assertIsNotNone(i)

	def test_type_parameters_fine(self):
		d = EvolutionStrategyMp1.typeParameters()
		self.assertIsNotNone(d)
...
class ESMpLTestCase(AlgorithmTestCase):
	def test_algorithm_info_fine(self):
		i = EvolutionStrategyMpL.algorithmInfo()
		self.assertIsNotNone(i)

	def test_typeParametes(self):
		d = EvolutionStrategyMpL.typeParameters()
...
class ESMLTestCase(AlgorithmTestCase):
	def test_algorithm_info_fine(self):
		i = EvolutionStrategyML.algorithmInfo()
		self.assertIsNotNone(i)
