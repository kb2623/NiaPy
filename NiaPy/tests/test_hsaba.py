...
class HSABATestCase(AlgorithmTestCase):
	...
	def test_algorithm_info_fine(self):
		...
		i = HybridSelfAdaptiveBatAlgorithm.algorithmInfo()
		self.assertIsNotNone(i)

	def test_type_parameters_fine(self):
		"""Test case for type parameters."""
		d = HybridSelfAdaptiveBatAlgorithm.typeParameters()
	...
	def test_custom_works_fine(self):
		...
		hsaba_custom = HybridSelfAdaptiveBatAlgorithm(NP=10, Limit=2, seed=self.seed)
		hsaba_customc = HybridSelfAdaptiveBatAlgorithm(NP=10, Limit=2, seed=self.seed)
		AlgorithmTestCase.algorithm_run_test(self, hsaba_custom, hsaba_customc, MyBenchmark())

	def test_griewank_works_fine(self):
		"""Test case for running algorithm on benchmark."""
		hsaba_griewank = HybridSelfAdaptiveBatAlgorithm(NP=10, seed=self.seed)
		hsaba_griewankc = HybridSelfAdaptiveBatAlgorithm(NP=10, seed=self.seed)
		AlgorithmTestCase.algorithm_run_test(self, hsaba_griewank, hsaba_griewankc)
